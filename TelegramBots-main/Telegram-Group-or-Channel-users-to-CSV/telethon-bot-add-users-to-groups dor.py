...
api_id = 24493552        # YOUR API_ID
api_hash = '1cff3d0d815269450c42385e52d8a5f0'        # YOUR API_HASH
phone = '+972557787773'        # YOUR PHONE NUMBER, INCLUDING COUNTRY CODE
...
def add_users_to_group():
    ...
    for user in users:
        try:
            ...
            print(f"Flood wait error occurred. Waiting for 59 seconds.")
            time.sleep(59)
        except:
            traceback.print_exc()
